            ...
            (item,key)=>{
                ...
                return(
                    <Card 
                        ...
                        border={this.props.isHighLight?((parseInt(this.props.order)===this.props.num)?(parseInt(this.props.which)===key):false):false}
                        //向上的信息传递，可以再拿到上层
                        mark = {this.props.mark}
                        demark = {this.props.demark}
                        //给一张图
                        ...
                        closeZone = {this.props.closeZone}
                    />
                );
            }
        )
