...
import block2 from "../../assets/loading.png"
import bar1 from "../../assets/main-page/bar1.png"
    ...
    handleBtn = () => {
        ...
        if (timer == null) {
          timer = setInterval(() => {
            ...
            percentage = Math.round(progressValue/980*100);
            if (progressValue >= 980) {
              percentage=100;
              progressValue=980;
              clearInterval(timer)
            }
    ...
    render(){
       return(
          <div>
             ...
             {this.loadingElement()}
             <img className='progress-box1' src={bar1}/>
          </div>
      ) 
    }
